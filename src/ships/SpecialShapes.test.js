...
import { Transformer, Hybrid } from './SpecialShapes.js'
...
jest.mock('../variants/TransformableVariants.js', () => ({
...
jest.mock('../variants/Variant3.js', () => ({
...
describe('Transformer', () => {
  ...
  describe('constructor', () => {
    it('should initialize with first form properties', () => {
      ...
      expect(transformer.symmetry).toBe('D4')
    })
    ...
    it('should create formVariants from forms', () => {
      ...
      } = require('../variants/TransformableVariants.js')
...
describe('Hybrid', () => {
  ...
  describe('constructor', () => {
    it('should initialize with provided properties', () => {
      ...
      expect(hybrid.symmetry).toBe('D4')
    ...
    it('should call setCells on primary', () => {
      expect(mockSubGroup1.setCells).toHaveBeenCalledWith(
        [
          [0, 0],
          [1, 1],
          [2, 2],
    ...
    it('should set subterrain to mixed', () => {
      const { mixed } = require('../terrain/terrain.js')
  ...
  describe('variants', () => {
    it('should return Variant3 instance', () => {
      const { Variant3 } = require('../variants/Variant3.js')
  ...
  describe('integration scenarios', () => {
    ...
    it('should handle single subgroup', () => {
      ...
      const h = new Hybrid('Single', 'S', 'D4', [[0, 0]], [group], null, {})
