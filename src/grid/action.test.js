...
describe('Actions', () => {
  ...
  describe('normalized', () => {
    it('should normalize bits by shifting up then left', () => {
      ...
      const shifted = normalizeUpLeft(b, actions.width, actions.height)
  ...
  describe('classifySymmetry', () => {
    it('should return c1 for high symmetry', () => {
      ...
      expect(a.classifySymmetry()).toBe('C1')
    })
    ...
    it('should return valid symmetry classification', () => {
      try {
        const sym = actions.classifySymmetry()
        const validSymmetries = ['D4', 'C4', 'V4', 'C2R', 'C2F', 'C1']
