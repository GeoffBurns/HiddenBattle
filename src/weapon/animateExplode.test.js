...
describe('Weapon.animateExplode', () => {
  it('appends wrapper with container-relative coordinates', () => {
    document.body.innerHTML = '<div id="container"></div><div id="target"></div>'
    const container = document.getElementById('container')
    const target = document.getElementById('target')

    // Mock bounding rects
    container.getBoundingClientRect = () => ({ left: 10, top: 20, width: 200, height: 200, right: 210, bottom: 220 })
    target.getBoundingClientRect = () => ({ left: 110, top: 120, width: 40, height: 40, right: 150, bottom: 160 })
    ...
    const expectedX = targetRect.left + targetRect.width / 2 - containerRect.left
