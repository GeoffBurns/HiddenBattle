...
describe('Ghost', () => {
  ...
  describe('constructor', () => {
    ...
    it('should store the special property', () => {
      expect(ghost.special).toEqual({ special: 'prop' })
    })
  ...
  describe('different ship types', () => {
    ...
    it('should handle different special properties', () => {
      const special = { damage: 2 }
      const ghostSpecial = new Ghost(
        { test: 'variant' },
        'S',
        mockContentBuilder,
        special
      )
      expect(ghostSpecial.special).toEqual(special)
    })
  })
})
